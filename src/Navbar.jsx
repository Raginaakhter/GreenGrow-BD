...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      animate={{ y: 0 }}
      transition={{ duration: 0.5 }}
      className={`fixed w-full top-0 left-0 z-50 transition-all ${scrolled ? "bg-sky-600 shadow-lg" : "bg-sky-500"
        }`}
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-5 py-3 text-white">
        {/* Logo */}
                ...
                >
                  {languages.map((lng) => (
                    <li
                      ...
                      className={`px-3 py-2 cursor-pointer hover:bg-gray-200 ${i18n.language === lng.code ? "bg-gray-100" : ""
                        }`}
                    >
                      {lng.label}
                    </li>
